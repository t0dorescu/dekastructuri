...
<head>
    ...
    <script src="js/jquery.mobilemenu.js?v=1.0.1"></script>
                    ...
                    <div class="clearfix">
                        ...
                        <div class="nav-collapse nav-collapse_ collapse">
                            <ul class="nav sf-menu clearfix">
                                ...
                                <li <?= ($page == 'proiecte') ? 'class="active"' : '' ?>><a href="proiecte.php"><?= t('Proiecte') ?></a></li>
                                <li <?= ($page == 'otel-beton-fasonat') ? 'class="active"' : '' ?>><a href="otel-beton-fasonat.php">Otel beton fasonat</a></li>
